...
namespace pjpl\e\db;
/**
 * Próba wykonania operacji zablokowanej zależnościami kluczy obcych.
 *
 * @package pjpl
 ...
 * @confirm 2014-10-28
 */
class ForeignKey extends \pjpl\e\a\E{
	/**
	 * @var string
	 */
	private $table;
	...
	public function __construct($class_name, $function_name, $table, $column, $value) {
		parent::__construct($class_name, $function_name, "");
		$this->table = $table;
		$this->column = $column;
		$this->value = $value;
	}
	...
	public function code() {
		return self::EDB_FOREIGNKEY;
	}
	public function name() {
		return 'ERR_EDB_FOREIGNKEY';
	}
}