 ...
 */
Ext.define('StanowiskaLiderowGrid',{
	extend : 'Ext.grid.Panel',
	xtype : 'stanowiska-liderow-grid',
	...
	constructor : function(){
		...
		thisSLG.StanowiskaLiderowStore = new Ext.create('StanowiskaLiderowStore');
		...
		Ext.apply(thisSLG,{
				...
				width : 500,
				height : 600,
				store : thisSLG.StanowiskaLiderowStore,
				columns:[
					{
						text : 'symbol',
						dataIndex : 'symbol',
	...
	setFirmaOddzial : function(firma_id, firma_oddzial_id){
		...
		thisSLG.StanowiskaLiderowStore.setFirmaOddzial(firma_id,firma_oddzial_id);
		if(firma_oddzial_id > 0){
			thisSLG.enable();
		}else{
			thisSLG.setDisabled(true);
//			thisSLG.setTitle('Wybierz oddział firmy');
		}
	}
});
