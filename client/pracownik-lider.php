...
if( !isset($_SESSION['USER_STATUS']) || (int)$_SESSION['USER_STATUS'] !== CRM::PRACOWNIK_LIDER){
	@session_destroy();
...
<!--		<link href="ext/5.0.1/resources/ext-all.css" rel="stylesheet" type="text/css" />
		...
		<script>
				Ext.getBody().mask('Start panelu pracownika');
		</script>
    ...
    <script src="app/model/admin-zwykly.model.js"></script>
		...
		<script src="app/model/stanowisko-pracownik.model.js"></script>
		...
		<script src="app/store/admin-zwykly.store.js"></script>
		...
		<script src="app/store/stanowiska-liderow-koperantow.store.js"></script>
		<script src="app/store/stanowiska-podleglej-grupy.store.js"></script>
		<script src="app/store/stanowiska-zespolu.store.js"></script>
    ...
    <script src="app/store/zarzad.store.js" ></script>
		...
		<script src="app/grid/leader/kroki-zadania.grid.js"></script>
		...
		<script src="app/view/stanowiska-liderow-kooperantow.grid.js"></script>
		<script src="app/view/stanowiska-przydzial-zadan.grid.js"></script>
		<script src="app/view/stanowiska-zespolu.grid.js"></script>
    ...
    <script src="app/win/dane-logowania.window.js" type="text/javascript"></script>
		...
		<script src="app/win/lider/generator-zadan.window.js"></script>
		<script src="app/win/lider/praca-z-zadaniami.window.js"></script>
		<script src="app/win/lider/przekaz-zadanie-liderowi.window.js"></script>
		<script src="app/win/lider/przekaz-zadanie-podwladnemu.window.js"></script>
		<script src="app/win/lider/przydzial-zadan.window.js"></script>

    <script src="app/pracownik-lider.js"></script>
