 ...
 * @work 4.2.0
 */
Ext.define('CRM.grid.Pracownicy',{
	...
	disabled : true,
	requires : [
		'CRM.store.Pracownicy'
	],
	constructor : function(){console.log('CRM.grid.Pracownicy::constructor()');
		var def = this;

		def.PracownicyStore = new Ext.create('CRM.store.Pracownicy');
				...
				bbar : [
					{
						...
						text : 'dodaj',
						handler : function(){
								var rec = Ext.create('CRM.model.Pracownicy',{
